      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="absolute right-0 top-0 bottom-0 w-full max-w-xl p-5 sm:p-6 bg-[#131017] border-l border-white/[0.06] flex flex-col shadow-[-24px_0_60px_-20px_rgba(0,0,0,0.6)] [box-shadow:inset_0_0_120px_rgba(224,176,131,0.04),-24px_0_60px_-20px_rgba(0,0,0,0.6)]"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-sm font-bold text-white font-[var(--font-headline)] flex items-center gap-2">
                  <span className="material-symbols-outlined text-[16px] text-[var(--color-warm)]">
                    cottage
                  </span>
              ...
              <button
                type="button"
                onClick={onClose}
                className="w-9 h-9 rounded-full flex items-center justify-center text-white/70 hover:text-white hover:bg-white/10 transition-colors active:scale-95"
